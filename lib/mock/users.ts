...
export const mockUsers: UserProfile[] = [
  // Resellers
  {
    ...
    bio: '✨ Your trusted beauty reseller | 💄 Skincare & Makeup | 📍 Jakarta | 💬 Chat for orders',
  ...
  },
  {
    ...
    bio: '📱 Best tech accessories | 🚚 Ready stock | 💯 Original guaranteed | 📍 Surabaya',
  ...
  },
  {
    ...
    bio: '🌿 Natural supplements | 💊 Vitamins & wellness | 🏃 Your health partner | 💚 Trusted since 2023',
  ...
  // Brands (already have brand accounts)
  {
    ...
    bio: 'Official account of Glow Beauty. Premium skincare for radiant skin.',
